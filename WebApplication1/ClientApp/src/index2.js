    ...
    componentDidMount = function () {
        fetch('jexcel')
            ...
            .then(data => {
                ...
                this.newOption.data = Array.prototype.map.call(product, s => [s.product.toString(), s.amount.toString(), s.rate.toString(), s.price.toString()]);
                this.el = jexcel(this.wrapper.current, this.state.newOption);
            });
    }
     ...
     changedata = function(product) { 
        ...
        let val = Array.prototype.map.call(product, s => [s.product.toString(), s.amount.toString(), s.rate.toString(), s.price.toString()]);
        console.log(val);
        this.state.newProduct = val;
        this.state.newOption.data = val;

        console.log("cccVal", val);
        console.log("cccRajak", this.state.newProduct);
        console.log("cccSajan", this.state.newOption);
